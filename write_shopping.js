...
const filePath = '/Users/yu/仓库/审核任务/0606-pdd/pdd-153-feature迭代-2/pdd-153-feature迭代-2/backend/routes/shopping.js';

fs.writeFileSync(filePath, content, 'utf8');
console.log('写入完成，文件大小:', fs.statSync(filePath).size, '字节');
